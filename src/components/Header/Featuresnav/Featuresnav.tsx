...
const Featuresnav = () => {
    return (
        <div>
            <ul className={s.list}>
                <li className={s.item}><NavLink className={({ isActive }) => isActive ? s.active : ""} to="/blogs/all">ALL</NavLink></li>
                ...
                <li className={s.item}><NavLink className={({ isActive }) => isActive ? s.active : ""} to="/blogs/features/tagged/Lookbooks">LOOKBOOKS</NavLink></li>
            </ul>
        </div>
    )
}
