    ...
    return (
        <div>
            <ul className={s.list}>
                ...
                <li className={s.item}><NavLink className={({ isActive }) => isActive ? s.active : ""} to="/pages/size-guide">SIZE GUIDE</NavLink></li>
                ...
                <li className={s.item}><NavLink className={({ isActive }) => isActive ? s.active : ""} to="/pages/accessibilitys">ACCESSIBILITY</NavLink></li>
            </ul>
        </div>
    )
}
